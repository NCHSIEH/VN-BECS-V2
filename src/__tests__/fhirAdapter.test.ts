...
describe('FhirAdapter expanded resources (RTM-FHIR-01)', () => {
  ...
  it('maps a crossmatch specimen to a Specimen', () => {
    const r = FhirAdapter.toFhirSpecimen({ id: 'XM1', patientId: 'P1', specimenDate: '2026-05-27' });
  ...
  it('maps an issue record to a SupplyDelivery', () => {
    const r = FhirAdapter.toFhirSupplyDelivery({ id: 'ISS1', componentId: '=W1234 24 000001', patientId: 'P1', issuedTo: 'Ward 5', issuedAt: '2026-05-29T02:00:00Z' });
  ...
  it('maps a transfusion to a Procedure', () => {
    const r = FhirAdapter.toFhirProcedure({ id: 'T1', patientId: 'P1', componentId: 'C1', startedAt: '2026-05-29T04:00:00Z', completedAt: '2026-05-29T04:30:00Z' });
  ...
  it('maps a severe adverse reaction to a serious AdverseEvent', () => {
    const r = FhirAdapter.toFhirAdverseEvent({ id: 'AR1', patientId: 'P1', transfusionId: 'T1', reactionType: 'Acute Hemolytic', severity: 'Critical', reportedAt: '2026-05-29T05:00:00Z' });
  ...
  it('maps a mild reaction to non-serious', () => {
    const r = FhirAdapter.toFhirAdverseEvent({ id: 'AR2', severity: 'Low', reactionType: 'Urticaria' });
