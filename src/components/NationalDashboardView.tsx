    ...
    <div className="flex-1 p-4 md:p-8 lg:p-10 space-y-8 md:space-y-12 animate-in fade-in duration-1000 overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 md:gap-8">
        ...
        <MetricCard 
          ...
          chartColor="indigo"
          details={[
            { label: t('national_utilization'), value: '89.3%', color: 'text-clinical-muted' },
            { label: t('national_fulfillment'), value: '98.6%', color: 'text-clinical-muted' }
          ]}
        />
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 md:gap-10">
        ...
        <div className="xl:col-span-8 space-y-10">
           <div className="clinical-card p-6 md:p-10 bg-clinical-bg/40 border-clinical-border rounded-[40px] relative overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-10 relative z-10">
                 <div>
                    <h3 className="text-xs font-black text-clinical-muted uppercase tracking-[0.3em] mb-2 flex items-center gap-3">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 relative z-10">
                 ...
                 <div className="hidden lg:flex flex-col items-center justify-center bg-clinical-card/20 rounded-[40px] border border-clinical-border p-4 min-h-[400px]">
        ...
        <div className="xl:col-span-4 space-y-10">
           <div className="clinical-card p-10 bg-clinical-card/30 border-clinical-border rounded-[40px] space-y-10 shadow-2xl">
              <div className="flex items-center gap-4 pb-6 border-b border-clinical-border">
                 <Zap className="text-amber-500" size={24} />
                 <h3 className="text-lg font-black text-clinical-text uppercase italic tracking-tighter">{t('national_simulation')}</h3>
              </div>
              ...
              <div className="space-y-8">
                 ...
                 <div className="space-y-6">
                    <div className="flex justify-between items-center">
                       <span className="text-[9px] font-black text-clinical-muted uppercase tracking-widest">{t('national_event_scale')}</span>
                       <span className="text-[10px] font-black text-rose-500">75%</span>
                    </div>
                    <div className="h-1 bg-clinical-bg rounded-full overflow-hidden">
                 ...
                 <div className="bg-rose-600/5 border border-rose-900/20 p-6 rounded-3xl space-y-4">
                    <div className="flex justify-between items-center">
                       <p className="text-[10px] font-black text-clinical-muted uppercase tracking-widest leading-relaxed">{t('national_forecasted_deficit')}</p>
                       <span className="text-rose-500 text-[10px] font-black">-2.4k Units</span>
                    </div>
                    <div className="flex justify-between items-center">
                       <p className="text-[10px] font-black text-clinical-muted uppercase tracking-widest leading-relaxed">{t('national_estimated_response')}</p>
                 ...
                 <button 
                   ...
                   className={`w-full py-5 rounded-[20px] font-black text-[10px] uppercase tracking-[0.3em] transition-all shadow-xl italic flex items-center justify-center gap-3 ${
                    activeScenario ? 'bg-clinical-bg text-clinical-muted' : 'bg-rose-600 text-white hover:bg-rose-500 shadow-rose-900/40'
                   }`}
                 >
            ...
            <div className="clinical-card p-10 bg-clinical-bg/40 border-clinical-border rounded-[40px] space-y-8">
               <div className="flex justify-between items-center">
                  <h3 className="text-[10px] font-black text-clinical-muted uppercase tracking-[0.3em] italic">{t('national_tasks')}</h3>
                  ...
                  {[
                    ...
                    <button key={i} className="w-full flex items-center justify-between p-5 bg-clinical-bg hover:bg-clinical-bg border border-clinical-border rounded-3xl transition-all group">
                       <div className="flex items-center gap-4">
                          <div className="p-3 bg-clinical-bg rounded-xl text-clinical-muted group-hover:text-rose-500 transition-colors">{task.icon}</div>
                          <div className="text-left">
                             <p className="text-[10px] font-black text-clinical-text uppercase tracking-wider">{task.task}</p>
                             <p className="text-[7px] font-black text-clinical-muted uppercase tracking-widest mt-1">{task.id} · {task.status}</p>
                          </div>
                       </div>
                       <ChevronRight size={16} className="text-clinical-text group-hover:text-clinical-text group-hover:translate-x-1 transition-all" />
                    </button>
                  ))}
               </div>
            </div>
            ...
            <div className="clinical-card p-10 bg-clinical-bg/40 border-clinical-border rounded-[40px] space-y-8">
               <div className="flex justify-between items-center">
                  <h3 className="text-[10px] font-black text-clinical-muted uppercase tracking-[0.3em] italic">{t('national_network_status')}</h3>
           ...
           <div className="clinical-card p-10 bg-clinical-bg/40 border-clinical-border rounded-[40px] space-y-8">
              <h3 className="text-[10px] font-black text-clinical-muted uppercase tracking-[0.3em] italic">{t('national_governance')}</h3>
              <div className="space-y-4">
                 <button className="w-full flex items-center justify-between p-6 bg-clinical-bg hover:bg-clinical-bg border border-clinical-border rounded-3xl transition-all group">
                    <div className="flex items-center gap-4">
                       <div className="p-3 bg-sky-500/10 rounded-xl text-sky-500 group-hover:scale-110 transition-transform"><Database size={18} /></div>
                       <div className="text-left">
                          <p className="text-[9px] font-black text-clinical-text uppercase tracking-wider">{t('national_security_report')}</p>
                          <p className="text-[7px] font-black text-clinical-muted uppercase tracking-widest mt-1">PDF | 12.4 MB</p>
                       </div>
                    </div>
                    <Download size={16} className="text-clinical-text group-hover:text-clinical-text" />
                 </button>
                 <button className="w-full flex items-center justify-between p-6 bg-clinical-bg hover:bg-clinical-bg border border-clinical-border rounded-3xl transition-all group">
                    <div className="flex items-center gap-4">
                       ...
                       <div className="text-left">
                          <p className="text-[9px] font-black text-clinical-text uppercase tracking-wider">{t('national_compliance_ledger')}</p>
                          <p className="text-[7px] font-black text-clinical-muted uppercase tracking-widest mt-1">CSV | 4.2 MB</p>
                       </div>
                    </div>
                    <Download size={16} className="text-clinical-text group-hover:text-clinical-text" />
                 </button>
...
function MetricCard({ title, value, unit, trend, details, chartColor }: any) {
  return (
    <div className="clinical-card p-6 md:p-8 bg-clinical-bg/40 border-clinical-border rounded-[32px] space-y-6 hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden">
       ...
       <div className="flex justify-between items-center relative z-10">
          <span className="text-[9px] font-black text-clinical-muted uppercase tracking-widest">{title}</span>
          <TrendingUp size={14} className="text-clinical-text group-hover:text-sky-500 transition-colors" />
       </div>
       
       <div className="flex items-end gap-3 relative z-10">
          <h2 className="text-2xl md:text-3xl font-black text-clinical-text italic tracking-tighter leading-none">{value}</h2>
          <div className="flex flex-col">
             <span className="text-[10px] font-black text-rose-500 leading-none mb-1">{trend}</span>
             <span className="text-[8px] font-black text-clinical-muted uppercase tracking-widest">{unit}</span>
          </div>
       </div>

       <div className="h-8 flex items-end gap-1 relative z-10">
          {[20, 35, 25, 45, 30, 55, 40].map((h, i) => (
             <div key={i} className="flex-1 bg-clinical-bg/50 rounded-sm">
       ...
       <div className="pt-4 border-t border-clinical-border grid grid-cols-3 gap-2 relative z-10">
          {details.map((d: any, i: number) => (
             <div key={i} className="space-y-1">
                <span className="text-[7px] font-black text-clinical-muted uppercase tracking-[0.2em]">{d.label}</span>
                <p className={`text-[9px] md:text-[10px] font-black ${d.color.includes('text') ? d.color : 'text-clinical-text'}`}>{d.value}</p>
             </div>
          ))}
       </div>
    </div>
...
function RegionHotspot({ name, status, demand, supply, percent }: any) {
   ...
   return (
      <div className="flex items-center gap-4 md:gap-6 p-4 rounded-2xl hover:bg-clinical-card/30 transition-all border border-transparent hover:border-clinical-border group">
         <div className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-lg transition-transform group-hover:scale-110 ${isCritical ? 'bg-rose-500 text-clinical-text shadow-rose-900/40' : 'bg-clinical-card text-clinical-muted'}`}>
            <MapPin size={18} />
         </div>
         <div className="flex-1 min-w-0">
            <div className="flex justify-between items-center mb-2">
               <span className="text-[10px] font-black text-clinical-text uppercase tracking-wider truncate mr-2">{name}</span>
            ...
            <div className="flex items-center gap-4">
               <div className="flex-1 h-1.5 bg-clinical-card rounded-full overflow-hidden">
                  <div className={`h-full transition-all duration-1000 ${isCritical ? 'bg-rose-600' : 'bg-sky-600'}`} style={{ width: `${percent}%` }} />
               </div>
               <span className="text-[8px] font-black text-clinical-muted uppercase tracking-widest shrink-0">{supply} / {demand}</span>
            </div>
         </div>
      </div>
   );
...
function ProgressBar({ label, percent, color }: any) {
  return (
    <div className="space-y-2">
      <div className="flex justify-between items-center">
        <span className="text-[8px] font-black text-clinical-muted uppercase tracking-widest">{label}</span>
        <span className="text-[9px] font-black text-clinical-text">{percent}%</span>
      </div>
      <div className="h-1 bg-clinical-card rounded-full overflow-hidden">
